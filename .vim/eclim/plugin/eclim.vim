...
if !exists("g:EclimHome")
  ...
  let g:EclimHome = '/home/vi/.eclipse/org.eclipse.platform_3.7.0_354837434/plugins/org.eclim_1.7.2'
  if has('win32unix')
...
if !exists("g:EclimEclipseHome")
  " set at build/install time.
  let g:EclimEclipseHome = '/home/vi/.eclipse/org.eclipse.platform_3.7.0_354837434'
  if has('win32unix')
